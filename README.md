...
- **Здоров'я** — журнал подій здоров'я в місячному календарі: заміри тиску/пульсу
  ...
  1–5, ліки, нотатки та власні типи подій. Нижче — графіки САТ/ДАТ і пульсу за
  обраний період (пресети тиждень/місяць/3 місяці) на часовій осі з пунктирними
  межами норми 135/85, а також середня вага за ISO-тижнями (план радить
  порівнювати саме тижневі середні). Будь-які типи подій можна **накласти на
  графік** і дивитись
  ...
  налаштовуються (⚙ Вигляд) і зберігаються на бекенді. Комбінації накладень
  зберігаються як **іменовані пресети** («Тиск і мігрені», «Вага і тиск», свої) —
