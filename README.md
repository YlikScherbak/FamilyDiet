...
| Страви з порціями на кожного | Вага з тижневими середніми (SVG без бібліотек) |
| --- | --- |
| ![Страви](.docs/screenshots/dishes.png) | ![Вага](.docs/screenshots/weight.png) |
...
- **Мінімум залежностей на фронтенді** (Vue, Router, Pinia, Vite — і все):
  графік ваги намальований вручну через SVG, UI-бібліотек немає.
