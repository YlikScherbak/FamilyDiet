...
const entriesOf = (memberId) =>
  entries.value
    .filter((e) => e.familyMemberId === memberId)
    .slice()
    .reverse()
...
const charts = computed(() =>
  app.members.map((m) => ({ member: m, chart: chartFor(m.id) })).filter((c) => c.chart !== null),
)
  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 16px">
      <div class="toolbar" style="margin-bottom: 0">
        ...
        <span class="muted"
          >Той самий день — запис оновиться. План радить зважуватись 3 рази на тиждень зранку.</span
        >
      </div>
